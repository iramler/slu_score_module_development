...
The data is obtained from the Basketball-Reference.com, a website that has in-depth statistics on the NBA, WNBA, NCAA basketball, and international basketball. [Basketball Reference](https://www.basketball-reference.com/){target="_blank"}.
